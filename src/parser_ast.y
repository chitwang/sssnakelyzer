...
funcdef: KEY_DEF NAME parameters DELIM_ARROW test DELIM_COLON func_body_suite
       ...
       /* | KEY_DEF NAME parameters DELIM_ARROW types DELIM_COLON func_body_suite */
...
try_stmt: KEY_TRY DELIM_COLON suite except_plus
        | KEY_TRY DELIM_COLON suite except_plus KEY_ELSE DELIM_COLON suite
        | KEY_TRY DELIM_COLON suite except_plus KEY_FINALLY DELIM_COLON suite
        | KEY_TRY DELIM_COLON suite except_plus KEY_ELSE DELIM_COLON suite KEY_FINALLY DELIM_COLON suite
        | KEY_TRY DELIM_COLON suite KEY_FINALLY DELIM_COLON suite

except_plus: KEY_EXCEPT DELIM_COLON suite
           | KEY_EXCEPT DELIM_COLON suite except_plus
...
dictorsetmaker: test DELIM_COLON test comp_for
              ...
              | test_or_star test_or_star_plus
              | test_or_star test_or_star_plus DELIM_COMMA

test_test_plus: test DELIM_COLON test
              | test DELIM_COLON test DELIM_COMMA
